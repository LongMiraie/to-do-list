package com.tdtu.todolistapplication.database;
...
public final class OnDataBaseAction_Impl implements OnDataBaseAction {
  ...
  public OnDataBaseAction_Impl(RoomDatabase __db) {
    ...
    this.__preparedStmtOfUpdateAnExistingRow = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "UPDATE Task SET taskTitle = ?, taskDescription = ?, date = ?, lastAlarm = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public void updateAnExistingRow(final String taskTitle, final String taskDescription,
      final String taskDate, final String taskTime) {
    __db.assertNotSuspendingTransaction();
