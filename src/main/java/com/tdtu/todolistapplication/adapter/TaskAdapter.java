package com.tdtu.todolistapplication.adapter;
...
import com.tdtu.todolistapplication.activity.MainActivity;
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuComplete:
                    ...
                    completeAlertDialog.setTitle(R.string.confirmation).setMessage(R.string.checkAsComplete).
